...
export interface DecorateSubscriptionProcedure<TDef extends ResolverDef> {
  /**
   * Create a set of type-safe subscription options that can be passed to subscription services
   *
 ...
 * @see https://trpc.io/docs/client/tanstack-angular-query/server-components
 */
